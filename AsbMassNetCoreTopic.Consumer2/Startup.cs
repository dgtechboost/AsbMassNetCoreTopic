using AsbMassNetCoreTopic.Consumer2.Consumers;
...
namespace AsbMassNetCoreTopic.Consumer2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var subscriptionName = "new-purchase-topic-subscriber_2";

            services.AddMassTransit(serviceCollectionConfigurator =>
            {
                serviceCollectionConfigurator.AddConsumer<PurchaseConsumer2>();
                ...
                serviceCollectionConfigurator.AddBus
                    (registrationContext => Bus.Factory.CreateUsingAzureServiceBus
                                                    (configurator =>
                                                    {
                                                        ...
                                                        {
                                                            endpointConfigurator.ConfigureConsumer<PurchaseConsumer2>(registrationContext);
                                                        });
